            ...
            steps {
                dir('facesong_flutter') {
                    ...
                    sh """
                        ...
                        sed -i '' "/create('alpha') {/,/}/ s/resValue 'string', 'app_name', '音潮 ALPHA'/resValue 'string', 'app_name', '${APP_NAME}'/" android/app/build.gradle
                    """
                }
            }
        }
...
- [扫码安装](${qrUrl})
        ...
        stage('上传 APK 到蒲公英') {
            ...
            steps {
                dir('facesong_flutter') {
                    script {
                        def apkPath = "build/app/outputs/flutter-apk/app-alpha-release.apk"
